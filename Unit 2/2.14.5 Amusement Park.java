public class AmusementPark extends ConsoleProgram
{
    ...
    public void run()
    {
        ...
        System.out.println((cannotRide)?"You may not ride the rollercoasters.":"You may ride the rollercoasters!");
        ...
        System.out.println((cannotSwim)?"You may not swim in the pool.":"You may swim in the pool!");
    }
}
